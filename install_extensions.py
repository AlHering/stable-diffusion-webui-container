...
extensions = [
    ...
    ("https://github.com/nonnonstop/sd-webui-3d-open-pose-editor.git", "f2d5aac5", "sd_dreambooth_extension"),
    ("https://github.com/thomasasfk/sd-webui-aspect-ratio-helper.git", "b03cce20", "sd_save_intermediate_images"),
    ("https://github.com/Mikubill/sd-webui-controlnet.git", "cfc37659", "sd-webui-3d-open-pose-editor"),
    ("https://github.com/Akegarasu/sd-webui-model-converter.git", "d19e2816", "sd-webui-aspect-ratio-helper"),
    ("https://github.com/d8ahazard/sd_dreambooth_extension.git", "926ae204", "sd-webui-controlnet"),
    ("https://github.com/AlUlkesh/sd_save_intermediate_images.git", "8115a847", "sd-webui-model-converter"),
