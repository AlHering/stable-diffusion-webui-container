...
extensions = [
    ("https://github.com/KohakuBlueleaf/a1111-sd-webui-lycoris.git",
     "025dea96", "a1111-sd-webui-lycoris"),
    ("https://github.com/DominikDoom/a1111-sd-webui-tagcomplete.git",
     "7f188563", "a1111-sd-webui-tagcomplete"),
    ("https://github.com/richrobber2/canvas-zoom.git", "4e2ab25a", "canvas-zoom"),
    ...
    ("https://github.com/opparco/stable-diffusion-webui-composable-lora.git",
     "e8f461f0", "stable-diffusion-webui-composable-lora"),
    ...
    ("https://github.com/AlUlkesh/stable-diffusion-webui-images-browser.git",
     "b2f6e4cb", "stable-diffusion-webui-images-browser"),
    ...
    ("https://github.com/ilian6806/stable-diffusion-webui-state.git",
     "85d8ef19", "stable-diffusion-webui-state"),
